<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/pointing-devices",
...
![A video snippet showing the left end of the Dock in front of the Home Screen. From the left, the visible app icons are Messages, Safari, Music, Mail, and Files. As the pointer moves across the first three icons from the left, it disappears beneath each icon in turn, lifting it slightly and letting it return to its original position before moving to the next icon.](videos/com.apple.HIG/lift-content-effect-home-screen.mp4)
...
![A video snippet showing an alert floating above the top half of a new event popover in Calendar. The alert contains text that reads Are you sure you want to discard this new event? and a button titled Discard Changes. As the pointer moves into the alert button, the button background darkens.](videos/com.apple.HIG/hover-content-effect-calendar-popover.mp4)
...
Unlike pointer shapes and content effects, accessories are secondary items that can combine with any pointer to communicate additional information. For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/UIPointerAccessory>.
...
![A video snippet showing an area at the bottom of Clock. The World Clock tab is selected and clock images and information for San Francisco, New York, and London are partially visible in the window. As the pointer moves in the tab bar, its highlighted rounded rectangle appearance seems to show a slight resistance as it slides from the World Clock tab to the Alarm tab and back again.](videos/com.apple.HIG/magnetics-clock.mp4)
...
**Specify the corner radius of a nonstandard element that receives the lift effect.** With the system-provided lift effect, the pointer transforms to match the element’s shape as it fades out. By default, the pointer uses the system-defined corner radius to transform into a rounded rectangle. If your element is a different shape — if it’s a circle, for example — you need to provide the radius so the pointer can animate seamlessly into the shape of the element. For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/UIPointerShape-swift.enum/roundedRect(_:radius:)>.
...
![An illustration of a custom pointer hovering over a resize handle on the edge of a shaded rectangle. Above the pointer is a small annotation that displays the image’s width and height values against a dark background.](images/com.apple.HIG/useful-pointer-annotation~dark@2x.png)
...
|-------------------------------------------------------------------------------------------------------------------|---------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
|![A pointer that resembles a diagonal arrow pointing up and to the left.](pointers-arrow.png)                      |Arrow                |Standard pointer for selecting and interacting with content and interface elements.                                                                                                                                           |<doc://com.apple.documentation/documentation/AppKit/NSCursor/arrow>                       |
|![A closed, gloved hand.](pointers-closed-hand.png)                                                                |Closed hand          |Dragging to reposition the display of content within a view—for example, dragging a map around in Maps.                                                                                                                       |<doc://com.apple.documentation/documentation/AppKit/NSCursor/closedHand>                  |
|![A pointer arrow with a small menu-like square to the right of the arrow.](pointers-contextual-menu.png)          |Contextual menu      |A contextual menu is available for the content below the pointer. This pointer is generally shown only when the Control key is pressed.                                                                                       |<doc://com.apple.documentation/documentation/AppKit/NSCursor/contextualMenu>              |
|![A plus symbol.](pointers-crosshair.png)                                                                          |Crosshair            |Precise rectangular selection is possible, such as when viewing an image in Preview.                                                                                                                                          |<doc://com.apple.documentation/documentation/AppKit/NSCursor/crosshair>                   |
|![A small pointer arrowhead with a circle underneath; the circle contains an Ex.](pointers-disappearing-item.png)  |Disappearing item    |A dragged item will disappear when dropped. If the item references an original item, the original is unaffected. For example, when dragging a mailbox out of the favorites bar in Mail, the original mailbox isn’t removed.   |<doc://com.apple.documentation/documentation/AppKit/NSCursor/disappearingItem>            |
|![A small pointer arrowhead with a circle underneath; the circle contains a plus symbol.](pointers-drag-copy.png)  |Drag copy            |Duplicates a dragged—not moved—item when dropped into the destination. Appears when pressing the Option key during a drag operation.                                                                                          |<doc://com.apple.documentation/documentation/AppKit/NSCursor/dragCopy>                    |
|![A curved arrow, pointing up and to the right.](pointers-drag-link.png)                                           |Drag link            |During a drag and drop operation, creates an alias of the selected file when dropped. The alias points to the original file, which remains unmoved. Appears when pressing the Option and Command keys during a drag operation.|<doc://com.apple.documentation/documentation/AppKit/NSCursor/dragLink>                    |
|![Opposing veritcal braces, used to form an insertion marker.](pointers-horizontal-beam.png)                       |Horizontal I beam    |Selection and insertion of text is possible in a horizontal layout, such as a TextEdit or Pages document.                                                                                                                     |<doc://com.apple.documentation/documentation/AppKit/NSCursor/iBeam>                       |
|![An open, gloved hand.](pointers-open-hand.png)                                                                   |Open hand            |Dragging to reposition content within a view is possible.                                                                                                                                                                     |<doc://com.apple.documentation/documentation/AppKit/NSCursor/openHand>                    |
|![A small pointer arrowhead with a do not enter symbol underneath.](pointers-operation-not-allowed.png)            |Operation not allowed|A dragged item can’t be dropped in the current location.                                                                                                                                                                      |<doc://com.apple.documentation/documentation/AppKit/NSCursor/operationNotAllowed>         |
|![A gloved hand, with the index finger extended.](pointers-pointing-hand.png)                                      |Pointing hand        |The content beneath the pointer is a URL link to a webpage, document, or other item.                                                                                                                                          |<doc://com.apple.documentation/documentation/AppKit/NSCursor/pointingHand>                |
|![A horizontal bar with a downward-pointing arrow at its midpoint.](pointers-resize-down.png)                      |Resize down          |Resize or move a window, view, or element downward.                                                                                                                                                                           |<doc://com.apple.documentation/documentation/AppKit/NSCursor/resizeDown>                  |
|![A vertical bar with a left-pointing arrow at its midpoint.](pointers-resize-left.png)                            |Resize left          |Resize or move a window, view, or element to the left.                                                                                                                                                                        |<doc://com.apple.documentation/documentation/AppKit/NSCursor/resizeLeft>                  |
|![A vertical bar with left- and right-pointing arrows extending from its midpoint.](pointers-resize-left-right.png)|Resize left/right    |Resize or move a window, view, or element to the left or right.                                                                                                                                                               |<doc://com.apple.documentation/documentation/AppKit/NSCursor/resizeLeftRight>             |
|![A vertical bar with a right-pointing arrow at its midpoint.](pointers-resize-right.png)                          |Resize right         |Resize or move a window, view, or element to the right.                                                                                                                                                                       |<doc://com.apple.documentation/documentation/AppKit/NSCursor/resizeRight>                 |
|![A horizontal bar with an up-pointing arrow at its midpoint.](pointers-resize-up.png)                             |Resize up            |Resize or move a window, view, or element upward.                                                                                                                                                                             |<doc://com.apple.documentation/documentation/AppKit/NSCursor/resizeUp>                    |
|![A horizontal bar with up- and down-pointing arrows extending from its midpoint.](pointers-resize-up-down.png)    |Resize up/down       |Resize or move a window, view, or element upward or downward.                                                                                                                                                                 |<doc://com.apple.documentation/documentation/AppKit/NSCursor/resizeUpDown>                |
|![Opposing horizontal braces, used to form an insertion marker.](pointers-vertical-beam.png)                       |Vertical I beam      |Selection and insertion of text is possible in a vertical layout.                                                                                                                                                             |<doc://com.apple.documentation/documentation/AppKit/NSCursor/iBeamCursorForVerticalLayout>|
...
![A recording that shows a pointer moving around, highlighting items, and scrolling content within a Safari window in visionOS. A picture-in-picture window is visible in the bottom left corner of the recording. It shows a person's hand operating a trackpad next to a keyboard outside the field of view. The person's gestures on the trackpad correspond to the pointer movements.](videos/com.apple.HIG/visionos-trackpad-pointer-input.mp4)
...
<doc://com.apple.documentation/documentation/SwiftUI/Input-events> — SwiftUI

<doc://com.apple.documentation/documentation/UIKit/pointer-interactions> — UIKit

<doc://com.apple.documentation/documentation/AppKit/mouse-keyboard-and-trackpad> — AppKit

#### Videos

  <doc://com.apple.documentation/videos/play/wwdc2020/10640>
