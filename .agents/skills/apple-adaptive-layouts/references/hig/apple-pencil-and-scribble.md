<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/apple-pencil-and-scribble",
...
![An illustration of Apple Pencil drawing a curved line that increases in thickness as more pressure is applied to the tool.](images/com.apple.HIG/apple-pencil-pressure~dark@2x.png)
...
**Prefer showing hover previews for Apple Pencil, not for a pointing device.** Although a pointing device can also respond to hover gestures, it might be confusing to provide the same visual feedback for both devices. If it makes sense in your app, you can restrict your hover preview to Apple Pencil only. For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/adopting-hover-support-for-apple-pencil>.
...
Using Apple Pencil Pro, people can squeeze to perform an action. You can design a custom behavior that responds to squeeze, but recognize that people may choose to configure the squeeze gesture to run an [App Shortcut](/design/Human-Interface-Guidelines/app-shortcuts) instead of app-specific actions.
...
<doc://com.apple.documentation/documentation/PencilKit>

<doc://com.apple.documentation/documentation/PaperKit>

#### Videos

  <doc://com.apple.documentation/videos/play/wwdc2026/203>

  <doc://com.apple.documentation/videos/play/wwdc2026/372>

  <doc://com.apple.documentation/videos/play/wwdc2025/285>
