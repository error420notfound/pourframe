<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/virtual-keyboards",
...
![A stylized representation of a numeric keypad shown on top of a grid that suggests the canvas of a design tool. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](images/com.apple.HIG/components-virtual-keyboard-intro@2x.png)
...
**Choose a keyboard that matches the type of content people are editing.** For example, you can help people enter numeric data by providing the numbers and punctuation keyboard. When you specify a semantic meaning for a text input area, the system can automatically provide a keyboard that matches the type of input you expect, potentially using this information to refine the keyboard corrections it offers. For developer guidance, see <doc://com.apple.documentation/documentation/SwiftUI/View/keyboardType(_:)> (SwiftUI), <doc://com.apple.documentation/documentation/SwiftUI/View/textContentType(_:)>(SwiftUI), <doc://com.apple.documentation/documentation/UIKit/UIKeyboardType> (UIKit), and <doc://com.apple.documentation/documentation/UIKit/UITextContentType> (UIKit).

**ASCII capable:**

![A partial screenshot of a keyboard on iPhone that displays all 26 letter keys in addition to the Shift, Delete, Numbers, Space, and Return keys. Typing suggestions appear above the keyboard and the Dictation button appears below it.](images/com.apple.HIG/virtual-keyboard-ascii-capable@2x.png)

**ASCII capable number pad:**

![A partial screenshot of a keyboard on iPhone that displays all 10 number keys in addition to the Delete key. Keys for the numbers 2 through 9 each include the 3 or 4 letters associated with the number on a phone.](images/com.apple.HIG/virtual-keyboard-ascii-capable-number-pad~dark@2x.png)

**Decimal pad:**

![A partial screenshot of a keyboard on iPhone that displays all 10 number keys in addition to the Delete and period keys. Keys for the numbers 2 through 9 each include the 3 or 4 letters associated with the number on a phone.](images/com.apple.HIG/virtual-keyboard-decimal-pad@2x.png)

**Default:**

![A partial screenshot of a keyboard on iPhone that displays all 26 letter keys in addition to the Shift, Delete, Numbers, Space, and Return keys. Typing suggestions appear above the keyboard and the  Emoji and Dictation buttons appear below it.](images/com.apple.HIG/virtual-keyboard-default~dark@2x.png)

**Email address:**

![A partial screenshot of a keyboard on iPhone that displays all 26 letter keys in addition to the Shift, Delete, Numbers, Space, period, at symbol, and Return keys. Typing suggestions appear above the keyboard and the Emoji button appears below it.](images/com.apple.HIG/virtual-keyboard-email-address~dark@2x.png)

**Name phone pad:**

![A partial screenshot of a keyboard on iPhone that displays all 26 letter keys in addition to the Shift, Delete, Numbers, Space, and Return keys. Typing suggestions appear above the keyboard and the Emoji and Dictation buttons appear below it.](images/com.apple.HIG/virtual-keyboard-name-phone-pad~dark@2x.png)

**Number pad:**

![A partial screenshot of a keyboard on iPhone that displays all 10 number keys in addition to the Delete key. Keys for the numbers 2 through 9 each include the 3 or 4 letters associated with the number on a phone.](images/com.apple.HIG/virtual-keyboard-number-pad~dark@2x.png)

**Numbers and punctuation:**

![A partial screenshot of a keyboard on iPhone that displays 10 number and 15 punctuation keys in addition to the secondary punctuation key and the Delete, Letters, Space, and Return keys. Typing suggestions appear above the keyboard and the Dictation button appears below it.](images/com.apple.HIG/virtual-keyboard-numbers-and-punctuation~dark@2x.png)

**Phone pad:**

![A partial screenshot of a keyboard on iPhone that displays all 10 number keys in addition to the Delete key and a key for plus, star, and hash. Keys for the numbers 2 through 9 each include the 3 or 4 letters associated with the number on a phone.](images/com.apple.HIG/virtual-keyboard-phone-pad@2x.png)

**Twitter:**

![A partial screenshot of a keyboard on iPhone that displays all 26 letter keys in addition to the Shift, Delete, Numbers, Space, at symbol, and hash keys. Typing suggestions appear above the keyboard and the Emoji and Dictation buttons appear below it.](images/com.apple.HIG/virtual-keyboard-twitter~dark@2x.png)

**URL:**

![A partial screenshot of a keyboard on iPhone that displays all 26 letter keys in addition to the Shift, Delete, Numbers, period, slash, dot com, and Return keys. Typing suggestions appear above the keyboard and the Emoji button appears below it.](images/com.apple.HIG/virtual-keyboard-url~dark@2x.png)

**Web search:**

![A partial screenshot of a keyboard on iPhone that displays all 26 letter keys in addition to the Shift, Delete, Numbers, Space, period, and Go keys. Typing suggestions appear above the keyboard and the Emoji and Dictation buttons appear below it.](images/com.apple.HIG/virtual-keyboard-web-search~dark@2x.png)

**Consider customizing the Return key type if it helps clarify the text-entry experience.** The Return key type is based on the keyboard type you choose, but you can change this if it makes sense in your app. For example, if your app initiates a search, you can use a search Return key type rather than the standard one so the experience is consistent with other places people initiate search. For developer guidance, see <doc://com.apple.documentation/documentation/SwiftUI/View/submitLabel(_:)> (SwiftUI) and <doc://com.apple.documentation/documentation/UIKit/UIReturnKeyType> (UIKit).

## Custom input views

In some cases, you can create an *input view* if you want to provide custom functionality that enhances data-entry tasks in your app. For example, Numbers provides a custom input view for entering numeric values while editing a spreadsheet. A custom input view replaces the system-provided keyboard while people are in your app. For developer guidance, see <doc://com.apple.documentation/documentation/SwiftUI/ToolbarItemPlacement> (SwiftUI) and <doc://com.apple.documentation/documentation/UIKit/UIResponder/inputViewController> (UIKit).
...
**Play the standard keyboard sound while people type.** The keyboard sound provides familiar feedback when people tap a key on the system keyboard, so they’re likely to expect the same sound when they tap keys in your custom input view. People can turn keyboard sounds off for all keyboard interactions in Settings > Sounds. For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/UIDevice/playInputClick()> (UIKit).
...
**Use the keyboard layout guide to make the keyboard feel like an integrated part of your interface.** Using the layout guide also helps you keep important parts of your interface visible while the virtual keyboard is onscreen. For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/adjusting-your-layout-with-keyboard-layout-guide>.
...
<doc://com.apple.documentation/documentation/SwiftUI/View/keyboardType(_:)> — SwiftUI

<doc://com.apple.documentation/documentation/SwiftUI/View/textContentType(_:)> — SwiftUI

<doc://com.apple.documentation/documentation/UIKit/UIKeyboardType> — UIKit
