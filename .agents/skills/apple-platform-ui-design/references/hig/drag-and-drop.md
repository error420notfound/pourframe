<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/drag-and-drop",
...
**Offer alternative ways to accomplish drag-and-drop actions.** Sometimes, drag-and-drop operations are inconvenient or impossible for people to perform, so it’s important to provide other ways to do the same things. For example, you can include menu commands that people can use to copy an item and move it to another location. In iOS and iPadOS, you can use accessibility APIs to identify sources and destinations so that people can use assistive technologies to drag and drop in your app (for developer guidance, see <doc://com.apple.documentation/documentation/ObjectiveC/NSObject-swift.class/accessibilityDragSourceDescriptors> and <doc://com.apple.documentation/documentation/ObjectiveC/NSObject-swift.class/accessibilityDropPointDescriptors>).
...
<doc://com.apple.documentation/documentation/UIKit/drag-and-drop> — UIKit

<doc://com.apple.documentation/documentation/AppKit/drag-and-drop> — AppKit

<doc://com.apple.documentation/documentation/FileProvider>

#### Videos

  <doc://com.apple.documentation/videos/play/wwdc2021/10059>

  <doc://com.apple.documentation/videos/play/wwdc2021/10289>

  <doc://com.apple.documentation/videos/play/wwdc2020/10206>
