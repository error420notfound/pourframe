<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/icons",
...
![A sketch of the Command key icon. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.](images/com.apple.HIG/foundations-icons-intro~dark@2x.png)
...
![A partial screenshot of the SF Symbols app showing the info panel for the character symbol, which looks like the capital letter A. Below the image, the following eight localized versions of the symbol are listed: Latin, Arabic, Hebrew, Hindi, Japanese, Korean, Thai, and Chinese.](images/com.apple.HIG/character-in-glyph@2x.png)



![A partial screenshot of the SF Symbols app showing the info panel for the text dot page symbol, which looks like three left-aligned horizontal lines inside a rounded rectangle. Below the image, the left-to-right and right-to-left localized versions are shown.](images/com.apple.HIG/abstract-text-in-glyph@2x.png)
...
|---------|-------------------------------------------------------------------------------------------------------|-----------------------|
|Cut      |![An icon showing a pair of scissors.](icons-symbols-meaning-cut)                                      |`scissors`             |
|Copy     |![An icon showing two copies of a document.](icons-symbols-meaning-copy)                               |`document.on.document` |
|Paste    |![An icon showing a document in front of a clipboard.](icons-symbols-meaning-paste)                    |`document.on.clipboard`|
|Done     |![An icon showing a checkmark.](icons-symbols-meaning-done-save)                                       |`checkmark `           |
|Save     |^                                                                                                      |^                      |
|Cancel   |![An icon showing an X.](icons-symbols-meaning-close-cancel)                                           |`xmark`                |
|Close    |^                                                                                                      |^                      |
|Delete   |![An icon showing a trash can.](icons-symbols-meaning-delete)                                          |`trash`                |
|Undo     |![An icon showing an arrow curving toward the top left.](icons-symbols-meaning-undo)                   |`arrow.uturn.backward` |
|Redo     |![An icon showing an arrow curving toward the top right.](icons-symbols-meaning-redo)                  |`arrow.uturn.forward`  |
|Compose  |![An icon showing a pencil positioned over a square.](icons-symbols-meaning-compose)                   |`square.and.pencil`    |
|Duplicate|![An icon showing a square with a plus sign on top of another square.](icons-symbols-meaning-duplicate)|`plus.square.on.square`|
|Rename   |![An icon showing a pencil.](icons-symbols-meaning-rename)                                             |`pencil`               |
|Move to  |![An icon showing a folder.](icons-symbols-meaning-move-to-folder)                                     |`folder`               |
|Folder   |^                                                                                                      |^                      |
|Attach   |![An icon showing a paperclip.](icons-symbols-meaning-attach)                                          |`paperclip`            |
|Add      |![An icon showing a plus sign.](icons-symbols-meaning-add)                                             |`plus`                 |
|More     |![An icon showing an ellipsis.](icons-symbols-meaning-more)                                            |`ellipsis`             |

### Selection

|Action  |Icon                                                                         |Symbol name       |
|--------|-----------------------------------------------------------------------------|------------------|
|Select  |![An icon showing a checkmark in a circle.](icons-symbols-meaning-select-all)|`checkmark.circle`|
|Deselect|![An icon showing an X.](icons-symbols-meaning-deselect-close)               |`xmark`           |
|Close   |^                                                                            |^                 |
|Delete  |![An icon showing a trash can.](icons-symbols-meaning-delete)                |`trash`           |
...
|Action      |Icon                                                                                                                                  |Symbol name             |
|------------|--------------------------------------------------------------------------------------------------------------------------------------|------------------------|
|Superscript |![An icon showing the capital letter A with the number 1 in the upper right corner.](icons-symbols-meaning-superscript)               |`textformat.superscript`|
|Subscript   |![An icon showing the capital letter A with the number 1 in the lower right corner.](icons-symbols-meaning-subscript)                 |`textformat.subscript`  |
|Bold        |![An icon showing the capital letter B in bold.](icons-symbols-meaning-bold)                                                          |`bold`                  |
|Italic      |![An icon showing the capital letter I in italics.](icons-symbols-meaning-italic)                                                     |`italic`                |
|Underline   |![An icon showing the capital letter U with an underline.](icons-symbols-meaning-underline)                                           |`underline`             |
|​​Align Left|![An icon showing a stack of four horizontal lines of varying widths that align at the left edge.](icons-symbols-meaning-align-left)  |`text.alignleft`        |
|Center      |![An icon showing a stack of four horizontal lines of varying widths that align in the center.](icons-symbols-meaning-align-center)   |`text.aligncenter`      |
|Justified   |![An icon showing a stack of four horizontal lines of identical widths.](icons-symbols-meaning-align-justified)                       |`text.justify`          |
|Align Right |![An icon showing a stack of four horizontal lines of varying widths that align at the right edge.](icons-symbols-meaning-align-right)|`text.alignright`       |

### Search

|Action                |Icon                                                                                                                      |Symbol name                      |
|----------------------|--------------------------------------------------------------------------------------------------------------------------|---------------------------------|
|Search                |![An icon showing a magnifying glass.](icons-symbols-meaning-search)                                                      |`magnifyingglass`                |
|Find                  |![An icon showing a magnifying glass above a document.](icons-symbols-meaning-find)                                       |`text.page.badge.magnifyingglass`|
|Find and Replace      |^                                                                                                                         |^                                |
|Find Next             |^                                                                                                                         |^                                |
|Find Previous         |^                                                                                                                         |^                                |
|Use Selection for Find|^                                                                                                                         |^                                |
|Filter                |![An icon showing a stack of three horizontal lines decreasing in width from top to bottom.](icons-symbols-meaning-filter)|`line.3.horizontal.decrease`     |

### Sharing and exporting

|Action|Icon                                                                                             |Symbol name          |
|------|-------------------------------------------------------------------------------------------------|---------------------|
|Share |![An icon showing an arrow pointing up from the middle of square.](icons-symbols-meaning-sharing)|`square.and.arrow.up`|
|Export|^                                                                                                |^                    |
|Print |![An icon showing a printer.](icons-symbols-meaning-print)                                       |`printer`            |

### Users and accounts

|Action |Icon                                                                                                                                     |Symbol name         |
|-------|-----------------------------------------------------------------------------------------------------------------------------------------|--------------------|
|Account|![An icon showing an abstract representation of a person’s head and shoulders in a circular outline.](icons-symbols-meaning-account-user)|`person.crop.circle`|
|User   |^                                                                                                                                        |^                   |
|Profile|^                                                                                                                                        |^                   |
...
|Action |Icon                                                                                  |Symbol name      |
|-------|--------------------------------------------------------------------------------------|-----------------|
|Dislike|![An icon showing a hand giving a thumbs down gesture.](icons-symbols-meaning-dislike)|`hand.thumbsdown`|
|Like   |![An icon showing a hand giving a thumbs up gesture.](icons-symbols-meaning-like)     |`hand.thumbsup`  |

### Layer ordering

|Action        |Icon                                                                                                                                                                                         |Symbol name                       |
|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------|
|Bring to Front|![An icon showing a stack of three squares overlapping each other, with the top square using a solid fill style while the other squares are outlines.](icons-symbols-meaning-bring-to-front) |`square.3.layers.3d.top.filled`   |
|Send to Back  |![An icon showing a stack of three squares overlapping each other, with the bottom square using a solid fill style while the other squares are outlines.](icons-symbols-meaning-send-to-back)|`square.3.layers.3d.bottom.filled`|
|Bring Forward |![An icon showing a stack of two squares overlapping each other, with the top square using a solid fill style while the other square is an outline.](icons-symbols-meaning-bring-forward)    |`square.2.layers.3d.top.filled`   |
|Send Backward |![An icon showing a stack of two squares overlapping each other, with the bottom square using a solid fill style while the other square is an outline.](icons-symbols-meaning-send-backwards)|`square.2.layers.3d.bottom.filled`|

### Other

|Action  |Icon                                                           |Symbol name |
|--------|---------------------------------------------------------------|------------|
|Alarm   |![An icon showing an alarm clock.](icons-symbols-meaning-alarm)|`alarm`     |
|Archive |![An icon showing a file box.](icons-symbols-meaning-archive)  |`archivebox`|
|Calendar|![An icon showing a calendar.](icons-symbols-meaning-calendar) |`calendar`  |
...
#### Videos
  ...
  <doc://com.apple.documentation/videos/play/wwdc2017/823>
