<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/keyboards",
...
|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
|Command     |![Outline of a stylized clover shape.](Keyboard_Command.svg)                                                                                                 |Prefer the Command key as the main modifier key in a custom keyboard shortcut.                                                                           |
|Shift       |![Outline of an upward-pointing arrow.](Keyboard_Shift.svg)                                                                                                  |Prefer the Shift key as a secondary modifier that complements a related shortcut.                                                                        |
|Option      |![Line segments that suggest a horizontally transformed Z shape combined with a short horizontal segment aligned with the top of the Z.](Keyboard_Option.svg)|Use the Option modifier sparingly for less-common commands or power features.                                                                            |
|Control     |![A shallow, upside-down V shape.](Keyboard_Control.svg)                                                                                                     |Avoid using the Control key as a modifier. The system uses Control in many systemwide features and shortcuts, like moving focus or capturing screenshots.|
...
![A recording that shows two hands typing on a physical keyboard while the person runs an app in visionOS. A virtual window is visible above the physical keyboard, and displays the entered text and suggestions.](videos/com.apple.HIG/visionos-keyboard-accessory-input.mp4)
...
<doc://com.apple.documentation/documentation/SwiftUI/KeyboardShortcut> — SwiftUI

<doc://com.apple.documentation/documentation/SwiftUI/Input-events> — SwiftUI

<doc://com.apple.documentation/documentation/UIKit/handling-key-presses-made-on-a-physical-keyboard> — UIKit
