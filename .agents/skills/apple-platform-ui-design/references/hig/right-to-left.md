<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/right-to-left",
...
![A sketch of a right-aligned bulleted list within a window, suggesting an interface displayed in a right-to-left language. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.](images/com.apple.HIG/foundations-rtl-intro~dark@2x.png)
...
![An illustration showing a layout of text and images in an interface. Three bars that represent text are left-aligned above a rounded rectangle area. A placeholder image is centered in the area, above another bar at the bottom edge. The bar inside the area is left-aligned.](images/com.apple.HIG/text-alignment-ltr-screen~dark@2x.png)



![An illustration showing a layout of text and images in an interface. Three bars that represent text are right-aligned above a rounded rectangle area. A placeholder image is centered in the area, above another bar at the bottom edge. The bar inside the area is right-aligned. The placeholder image isn't flipped.](images/com.apple.HIG/text-alignment-rtl-screen~dark@2x.png)
...
![An image showing two paragraphs of placeholder copy. The first paragraph is in Arabic and is right-aligned. The second paragraph is in English and is left-aligned.](images/com.apple.HIG/paragraph-alignment-correct@2x.png)

![A checkmark in a circle to indicate a correct example.](images/com.apple.HIG/checkmark@2x.png)



![An image showing two paragraphs of placeholder copy. The first paragraph is in Arabic and the second paragraph is in English. Both paragraphs are right-aligned.](images/com.apple.HIG/paragraph-alignment-wrong~dark@2x.png)
...
![An illustration of a right-aligned list of gray bars that represent right-to-left text.](images/com.apple.HIG/mixed-script-list-alignment-correct@2x.png)

![A checkmark in a circle to indicate a correct example.](images/com.apple.HIG/checkmark@2x.png)



![An illustration of a list of gray bars. The first, third, fourth, and fifth bars represent right-to-left text. The second bar is incorrectly left-aligned.](images/com.apple.HIG/mixed-script-list-alignment-wrong@2x.png)
...
![From the left, the numerals one, two, and three in Western Arabic numerals.](images/com.apple.HIG/textformat-123-ltr@2x.png)



![From the right, the numerals one, two, and three in Eastern Arabic numerals.](images/com.apple.HIG/textformat-123-ar~dark@2x.png)
...
![From the left, the two words order and number followed by the number 123456 in Latin script.](images/com.apple.HIG/latin-numerals~dark@2x.png)



![From the right, the two words order and number followed by the number 12345 in Hebrew script.](images/com.apple.HIG/hebrew-numerals~dark@2x.png)



![From the right, the two words order and number in Arabic script, followed by the number 12345 in Western Arabic numerals.](images/com.apple.HIG/western-arabic-numerals~dark@2x.png)



![From the right, the two words order and number in Arabic script, followed by the number 12345 in Eastern Arabic numerals.](images/com.apple.HIG/eastern-arabic-numerals@2x.png)
...
![A horizontal row of five stars. From the left, the first three and a half stars are filled. Below the stars is a row of Latin numerals, each numeral vertically aligned with a star above. From the left, the numerals are one, two, three, four, and five.](images/com.apple.HIG/match-numeral-order-to-directional-controls-latin@2x.png)



![A horizontal row of five stars. From the right, the first three and a half stars are filled. Below the stars is a row of Eastern Arabic numerals, each numeral vertically aligned with a star above. From the right, the numerals are one, two, three, four, and five.](images/com.apple.HIG/match-numeral-order-to-directional-controls-eastern-arabic~dark@2x.png)



![A horizontal row of five stars. From the right, the first three and a half stars are filled. Below the stars is a row of Hebrew numerals, each numeral vertically aligned with a star above. From the right, the numerals are one, two, three, four, and five.](images/com.apple.HIG/match-numeral-order-to-directional-controls-western-arabic-hebrew@2x.png)



![A horizontal row of five stars. From the right, the first three and a half stars are filled. Below the stars is a row of Western Arabic numerals, each numeral vertically aligned with a star above. From the right, the numerals are one, two, three, four, and five.](images/com.apple.HIG/match-numeral-order-to-directional-controls-western-arabic-hebrew@2x.png)
...
![A simplified illustration of a globe that uses solid black shapes to show most of Africa, Europe, Asia, Australia, and Antarctica.](images/com.apple.HIG/image-displayed-right@2x.png)

![A checkmark in a circle to indicate a correct example.](images/com.apple.HIG/checkmark@2x.png)



![A simplified illustration of a globe that shows a horizontally flipped Eastern hemisphere with Africa on the far right and Australia on the far left.](images/com.apple.HIG/image-displayed-wrong~dark@2x.png)
...
When you use [SF Symbols](/design/Human-Interface-Guidelines/sf-symbols) to supply interface icons for your app, you get variants for the RTL context and localized symbols for Arabic and Hebrew, among other languages. If you create custom symbols, you can specify their directionality. For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/creating-custom-symbol-images-for-your-app>.
...
![A rounded rectangle that contains three horizontal left-aligned lines.](images/com.apple.HIG/doc-plaintext-ltr@2x.png)



![A rounded rectangle that contains three horizontal right-aligned lines.](images/com.apple.HIG/doc-plaintext-rtl~dark@2x.png)
...
![The outline of a speaker with three concentric curved lines emanating to the right.](images/com.apple.HIG/speaker-wave-3-ltr@2x.png)



![The outline of a speaker with three concentric curved lines emanating to the left.](images/com.apple.HIG/speaker-wave-3-rtl@2x.png)
...
![A rounded square that contains the black Apple TV logo, which consists of a solid black apple to the left of the lowercase letters T and V.](images/com.apple.HIG/appletv-ltr@2x.png)



![A checkmark.](images/com.apple.HIG/checkmark-ltr@2x.png)
...
![A black disk with two white lines in the nine o'clock position.](images/com.apple.HIG/clock-fill-ltr~dark@2x.png)



![A pencil with an eraser, slanted at about forty-five degrees with the point in the bottom-left.](images/com.apple.HIG/pencil-ltr@2x.png)



![The silhouette of a game controller with a white plus sign on the left and two white buttons on the right.](images/com.apple.HIG/gamecontroller-fill-ltr@2x.png)
...
![A silhouette of a speaker pointing right with a backslash on top of it.](images/com.apple.HIG/speaker-slash-fill-ltr@2x.png)



![A silhouette of a speaker pointing left with a backslash on top of it.](images/com.apple.HIG/speaker-slash-fill-rtl@2x.png)
...
![A silhouette of a wheeled shopping cart that faces right. A white plus sign inside a black disk is in the top-right corner.](images/com.apple.HIG/cart-fill-badge-plus-ltr@2x.png)

![A checkmark in a circle to indicate a correct example.](images/com.apple.HIG/checkmark@2x.png)



![A silhouette of a wheeled shopping cart that faces left. A white plus sign inside a black disk is in the top-right corner.](images/com.apple.HIG/cart-fill-badge-rtl-unbalanced@2x.png)

![An X in a circle to indicate an incorrect example.](images/com.apple.HIG/crossout@2x.png)



![A silhouette of a wheeled shopping cart that faces left. A white plus sign inside a black disk is in the top-left corner.](images/com.apple.HIG/cart-fill-badge-plus-rtl~dark@2x.png)
...
![A rounded rectangle that contains a black dot in the top-right corner. The outline of a magnifying glass that contains a stack of two left-aligned lines is on top of the rectangle and to the left of the dot, slanted at about 135 degrees.](images/com.apple.HIG/mail-and-text-magnifyingglass-ltr@2x.png)



![A rounded rectangle that contains a black dot in the top-left corner. The outline of a magnifying glass that contains a stack of two rightt-aligned lines is on top of the rectangle and to the right of the dot, slanted at about 135 degrees.](images/com.apple.HIG/mail-and-text-magnifyingglass-rtl~dark@2x.png)
...
<doc://com.apple.documentation/documentation/SwiftUI/Preparing-views-for-localization> — SwiftUI

#### Videos

  <doc://com.apple.documentation/videos/play/wwdc2025/222>

  <doc://com.apple.documentation/videos/play/wwdc2022/10034>
