<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/charting-data",
...
![A sketch of a bar chart, suggesting data representation. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.](images/com.apple.HIG/patterns-charting-data-intro~dark@2x.png)
...
![A screenshot of the Activity screen in the Health app on iPhone. The app uses a set of three bar charts to depict information from the three Activity Rings over the currently chosen one-day period.](images/com.apple.HIG/charts-activity~dark@2x.png)
