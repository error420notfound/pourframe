<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/labels",
...
> Developer note: To display uneditable text, SwiftUI defines two components: <doc://com.apple.documentation/documentation/SwiftUI/Label> and <doc://com.apple.documentation/documentation/SwiftUI/Text>.
...
|----------------|---------------------------------------------------|---------------------------------------------------------------------------|---------------------------------------------------------------------------------|
|Label           |Primary information                                |<doc://com.apple.documentation/documentation/UIKit/UIColor/label>          |<doc://com.apple.documentation/documentation/AppKit/NSColor/labelColor>          |
|Secondary label |A subheading or supplemental text                  |<doc://com.apple.documentation/documentation/UIKit/UIColor/secondaryLabel> |<doc://com.apple.documentation/documentation/AppKit/NSColor/secondaryLabelColor> |
|Tertiary label  |Text that describes an unavailable item or behavior|<doc://com.apple.documentation/documentation/UIKit/UIColor/tertiaryLabel>  |<doc://com.apple.documentation/documentation/AppKit/NSColor/tertiaryLabelColor>  |
|Quaternary label|Watermark text                                     |<doc://com.apple.documentation/documentation/UIKit/UIColor/quaternaryLabel>|<doc://com.apple.documentation/documentation/AppKit/NSColor/quaternaryLabelColor>|
...
> Developer note: To display uneditable text in a label, use the <doc://com.apple.documentation/documentation/AppKit/NSTextField/isEditable> property of <doc://com.apple.documentation/documentation/AppKit/NSTextField>.
...
Consider using date and timer components in complications. For design guidance, see [Complications](https://developer.apple.com/design/human-interface-guidelines/components/system-experiences/complications); for developer guidance, see <doc://com.apple.documentation/documentation/SwiftUI/Text>.
...
<doc://com.apple.documentation/documentation/SwiftUI/Label> — SwiftUI

<doc://com.apple.documentation/documentation/SwiftUI/Text> — SwiftUI

<doc://com.apple.documentation/documentation/UIKit/UILabel> — UIKit

<doc://com.apple.documentation/documentation/AppKit/NSTextField> — AppKit
