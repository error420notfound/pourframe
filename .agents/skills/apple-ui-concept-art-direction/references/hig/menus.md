<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/menus",
...
> Note: Several system-provided components also include menus that support specific use cases. For example, a [pop-up button](doc://com.apple.HIG/design/Human-Interface-Guidelines/pop-up-buttons) or [pull-down button](doc://com.apple.HIG/design/Human-Interface-Guidelines/pull-down-buttons) can reveal a menu of options directly related to its action; a [context menu](doc://com.apple.HIG/design/Human-Interface-Guidelines/context-menus) lets people access a small number of frequently used actions relevant to their current view or task; and in macOS and iPadOS, [menu bar](doc://com.apple.HIG/design/Human-Interface-Guidelines/the-menu-bar) menus contain all the commands people can perform in the app or game.
...
> Note: Depending on menu layout, an iOS, iPadOS, or visionOS app can display a few unlabeled menu items that use only symbols or icons to identify them. For guidance, see <doc://com.apple.HIG/design/Human-Interface-Guidelines/menus#visionOS> and <doc://com.apple.HIG/design/Human-Interface-Guidelines/menus#iOS-iPadOS>.
...
![An illustration of a menu containing the days of the week. Each menu item is represented by a different symbol with no relation to the corresponding day.](images/com.apple.HIG/menus-days-of-the-week-incorrect-icons~dark@2x.png)

![An X in a circle to indicate incorrect usage.](images/com.apple.HIG/crossout@2x.png)



![An illustration of a menu containing the days of the week with no accompanying symbols.](images/com.apple.HIG/menus-days-of-the-week-correct-no-icons~dark@2x.png)
...
![An illustration of a menu containing four items, with a checkmark icon on the leading edge of the second item.](images/com.apple.HIG/menus-toggled-item~dark@2x.png)
...
![A diagram showing small, medium, and large menu layouts, each containing the same set of menu items.](images/com.apple.HIG/small-medium-large-menu-layouts~dark@2x.png)
...
For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/UIMenu/preferredElementSize>.
...
**Prefer the subtle breakthrough effect in most cases.** This effect blends the presentation with its surrounding content, to maintain legibility and usability while preserving the depth and context of the scene. When you select <doc://com.apple.documentation/documentation/SwiftUI/BreakthroughEffect/automatic> for the breakthrough effect of a menu that overlaps with 3D content, the system applies <doc://com.apple.documentation/documentation/SwiftUI/BreakthroughEffect/subtle> by default. You can use <doc://com.apple.documentation/documentation/SwiftUI/BreakthroughEffect/prominent> if it’s important to display a menu prominently over the entire scene in your app or game, but this can disrupt the experience for people and potentially cause discomfort. Alternatively, you can use <doc://com.apple.documentation/documentation/SwiftUI/BreakthroughEffect/none> to fully occlude your menu behind other 3D content — for example, in a puzzle game that requires people to navigate around barriers — but this may make it difficult for people to see and access the menu.
...
<doc://com.apple.documentation/documentation/SwiftUI/Menu> — SwiftUI

<doc://com.apple.documentation/documentation/UIKit/menus-and-shortcuts> — UIKit

<doc://com.apple.documentation/documentation/AppKit/menus> — AppKit
