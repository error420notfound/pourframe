<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/charts",
...
To learn about designing charts to enhance your experience, see [Charting data](/design/Human-Interface-Guidelines/charting-data); for developer guidance, see <doc://com.apple.documentation/documentation/Charts/Creating-a-chart-using-Swift-Charts>.
...
**Choose a mark type based on the information you want to communicate about the data.** Some of the most familiar mark types are bar, line, and point; for developer guidance on these and other mark types, see <doc://com.apple.documentation/documentation/Charts>.
...
![A bar chart that depicts the number of steps for each day in a month.](images/com.apple.HIG/charts-bar-marks~dark@2x.png)
...
![A point-mark chart that depicts per-day readings of heartbeats per minute over a 5 1/2-month period.](images/com.apple.HIG/charts-point-marks~dark@2x.png)
...
![An illustration of Battery Settings, which uses a chart to depict battery charge over time, where the charge can vary within a fixed range from 0% to 100%.](images/com.apple.HIG/charts-fixed-range-axis~dark@2x.png)
...
![An illustration of the Steps chart in the Health app, which shows the average number of steps per day for a single week.](images/com.apple.HIG/charts-dynamic-range-axis-small~dark@2x.png)



![An illustration of the Steps chart in the Health app, which shows the average number of steps per day in a one-month period.](images/com.apple.HIG/charts-dynamic-range-axis-large~dark@2x.png)
...
![An illustration of a blood pressure chart in the Health app that uses a red circle to represent systolic values and a black or white diamond to represent diastolic values.](images/com.apple.HIG/charts-colors~dark@2x.png)
...
<doc://com.apple.documentation/documentation/Charts>

#### Videos

  <doc://com.apple.documentation/videos/play/wwdc2025/313>

  <doc://com.apple.documentation/videos/play/wwdc2022/110342>

  <doc://com.apple.documentation/videos/play/wwdc2022/110340>
