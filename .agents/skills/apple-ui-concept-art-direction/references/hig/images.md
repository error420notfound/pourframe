<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/images",
...
![A sketch of a photo, suggesting imagery. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.](images/com.apple.HIG/foundations-images-intro~dark@2x.png)
...
![Image of a circle that's in standard resolution at scale factor of @1x, and is 10 by 10 pixels.](images/com.apple.HIG/image-resolution-1x@2x.png)



![Image of a circle that's in high resolution at a scale factor of @2x, and is 20 by 20 pixels.](images/com.apple.HIG/image-resolution-2x@2x.png)



![Image of a circle that's in high resolution at a scale factor of @3x, and is 30 by 30 pixels.](images/com.apple.HIG/image-resolution-3x~dark@2x.png)
...
|iPadOS, watchOS|@2x                                                                                        |
|iOS            |@2x and @3x                                                                                |
|visionOS       |@2x or higher (see <doc://com.apple.HIG/design/Human-Interface-Guidelines/images#visionOS>)|
...
![An animation of a tvOS app icon moving to show the parallax effect.](videos/com.apple.HIG/tvos-app-icon-parallax-effect-animation.mp4)
...
> Important: Your tvOS [app icon](doc://com.apple.HIG/design/Human-Interface-Guidelines/app-icons#tvOS) must use a layered image. For other focusable images in your app, including <doc://com.apple.HIG/design/Human-Interface-Guidelines/top-shelf> images, layered images are strongly encouraged, but optional.
...
**Use standard interface elements to display layered images.** If you use standard views and system-provided focus APIs — such as <doc://com.apple.documentation/documentation/SwiftUI/FocusState> — layered images automatically get the parallax treatment when people bring them into focus.
...
<doc://com.apple.documentation/documentation/visionOS/drawing-sharp-layer-based-content> — visionOS

<doc://com.apple.documentation/documentation/SwiftUI/Images> — SwiftUI
