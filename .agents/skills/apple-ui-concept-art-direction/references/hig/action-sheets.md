<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/action-sheets",
...
**Make destructive choices visually prominent.** Use the destructive style for buttons that perform destructive actions, and place these buttons at the top of the action sheet where they tend to be most noticeable. For developer guidance, see <doc://com.apple.documentation/documentation/SwiftUI/ButtonRole/destructive> (SwiftUI) or <doc://com.apple.documentation/documentation/UIKit/UIAlertAction/Style-swift.enum/destructive> (UIKit).
...
<doc://com.apple.documentation/documentation/SwiftUI/View/confirmationDialog(_:isPresented:titleVisibility:actions:)-46zbb> — SwiftUI

<doc://com.apple.documentation/documentation/UIKit/UIAlertController/Style/actionSheet> — UIKit
