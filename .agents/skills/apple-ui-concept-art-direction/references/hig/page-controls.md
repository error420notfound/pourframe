<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/page-controls",
...
![A stylized representation of a page control with an indicator denoting the active page. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](images/com.apple.HIG/components-page-dots-intro~dark@2x.png)
...
If it enhances your app or game, you can provide a custom image to use as the default image for all indicators and you can also supply a different image for a specific page. For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/UIPageControl/preferredIndicatorImage> and <doc://com.apple.documentation/documentation/UIKit/UIPageControl/setIndicatorImage(_:forPage:)>.
...
> Developer note: In the API, *tapping* is a *discrete interaction*, whereas *scrubbing* is a *continuous interaction*; for developer guidance, see <doc://com.apple.documentation/documentation/UIKit/UIPageControl/InteractionState-swift.enum>.
...
For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/UIPageControl/backgroundStyle-swift.property>.
...
<doc://com.apple.documentation/documentation/SwiftUI/PageTabViewStyle> — SwiftUI

<doc://com.apple.documentation/documentation/UIKit/UIPageControl> — UIKit
