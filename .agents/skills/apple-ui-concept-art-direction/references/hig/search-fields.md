<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/search-fields",
...
![A stylized representation of a search field containing placeholder text and a dictation icon. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](images/com.apple.HIG/components-search-field-intro~dark@2x.png)

A search field is an editable text field that displays a Search icon, a Clear button, and placeholder text where people can enter what they are searching for. Search fields can use a [scope bar](/design/Human-Interface-Guidelines/search-fields#Scope-bars-and-tokens) as well as [tokens](/design/Human-Interface-Guidelines/search-fields#Scope-bars-and-tokens) to help filter and refine the scope of their search. Across each platform, there are different patterns for accessing search based on the goals and design of your app.

For developer guidance, see <doc://com.apple.documentation/documentation/SwiftUI/Adding-a-search-interface-to-your-app>; for guidance related to systemwide search, see [Searching](/design/Human-Interface-Guidelines/searching).
...
![An illustration of a Mac screen with a search field on the trailing edge of the toolbar. The search field has the word Design entered into the field, and three search suggestions appear in a list beneath the field.](images/com.apple.HIG/search-fields-toolbar-search-mac~dark@2x.png)
...
![An illustration of an iPad screen with a search field at the top of the sidebar on the leading edge of the screen.](images/com.apple.HIG/search-fields-ipad-search-in-sidebar~dark@2x.png)
...
![An illustration of an iPad screen with a tab bar at the top edge. The trailing side of the tab bar includes a Search tab with a distinct background color to differentiate it from other tab areas.](images/com.apple.HIG/search-fields-ipad-search-in-tab-bar~dark@2x.png)
...
A search screen is a specialized keyboard screen that helps people enter search text, displaying search results beneath the keyboard in a fully customizable view. For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/UISearchController>.
...
<doc://com.apple.documentation/documentation/SwiftUI/Adding-a-search-interface-to-your-app> — SwiftUI

<doc://com.apple.documentation/documentation/SwiftUI/View/searchable(text:placement:prompt:)> — SwiftUI

<doc://com.apple.documentation/documentation/UIKit/UISearchBar> — UIKit

<doc://com.apple.documentation/documentation/UIKit/UISearchTextField> — UIKit

<doc://com.apple.documentation/documentation/AppKit/NSSearchField> — AppKit

#### Videos

  <doc://com.apple.documentation/videos/play/wwdc2026/292>

  <doc://com.apple.documentation/videos/play/wwdc2025/356>

  <doc://com.apple.documentation/videos/play/wwdc2021/10126>
