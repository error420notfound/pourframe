<!--
{
  ...
  "identifier" : "/design/Human-Interface-Guidelines/progress-indicators",
...
![A stylized representation of a spinning indeterminate activity indicator above a progress bar. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](images/com.apple.HIG/components-progress-indicators-intro~dark@2x.png)
...
![An image of a horizontal progress bar in macOS filled almost to the midpoint with solid color.](images/com.apple.HIG/progress-indicator-determinate-bar~dark@2x.png)



![An image of a circular progress indicator in macOS filled almost to the eight o'clock position with solid color.](images/com.apple.HIG/progress-indicator-determinate-circle@2x.png)
...
![An image of a spinning, circular activity indiator on watchOS.](images/com.apple.HIG/activity-indicators-watch@2x.png)

For developer guidance, see <doc://com.apple.documentation/documentation/SwiftUI/ProgressView>.
...
![A screenshot of a refresh content control spinning while Mail checks for new messages.](images/com.apple.HIG/refresh-controls~dark@2x.png)
...
For developer guidance, see <doc://com.apple.documentation/documentation/UIKit/UIRefreshControl>.
...
<doc://com.apple.documentation/documentation/SwiftUI/ProgressView> — SwiftUI

<doc://com.apple.documentation/documentation/UIKit/UIProgressView> — UIKit

<doc://com.apple.documentation/documentation/UIKit/UIActivityIndicatorView> — UIKit

<doc://com.apple.documentation/documentation/UIKit/UIRefreshControl> — UIKit

<doc://com.apple.documentation/documentation/AppKit/NSProgressIndicator> — AppKit
